...
STUDIO_TOOLS: tuple[StudioTool, ...] = (
    ...
    StudioTool(
        ...
        "Atmosphere Capture Profiler",
        "Read native TrueVision `.tvcells` captures and derive fog/mist/cloud/rain-glass state profiles with 6-1-6 windows.",
        ("storage/artifacts/weather", "storage/manifests"),
        "analysis_tool",
    ),
    StudioTool(
        "atmosphere_toolset_create",
        "Weather / Atmosphere Toolset",
        "Create reusable state-pattern tools for fog, mist, clouds, and rain on glass.",
        ("storage/templates", "storage/manifests", "storage/artifacts/weather"),
        "state_pattern_tool",
    ),
    StudioTool(
        "element_creation_profile_from_capture",
        "Element Creation Profile Tool",
        "Convert temporary teacher capture state into compact behavior signatures, then purge bulky observed state after verification.",
        ("storage/artifacts/element_creation_profiles", "storage/manifests", "storage/receipts", "storage/reports"),
        "learning_intake_tool",
    ),
    StudioTool(
...
BUILTIN_RENDER_PRESETS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "name": "Dead Memory Vice Chamber",
        "renderer": "truevision_weird_occlusion_rs",
        "scene_mode": "dead_memory_vice_chamber",
        "visual_mode": "dead_memory_vice_chamber",
        "status": "ready",
        "purpose": "Dark gothic-industrial memory-exorcism lane: heartbreak and deception shown as mechanical pressure, black iron vice jaws, cracked memory core, fog, rain-glass distortion, ash, lightning bloom, and a thin gold-white survival fracture.",
        ...
        "audio_mapping": {
            "rms": ["vice_pressure", "fog_breathing", "memory_core_bloom"],
            "bass": ["jaw_closure_weight", "industrial_floor_pulse", "red_glass_pressure"],
            "highs": ["white_truth_cuts", "rain_glass_distortion", "ash_spark_edges"],
            "beat": ["controlled_lightning_bloom", "core_crack_pulse", "vice_impact_flash"],
            "vocal_presence": ["female_whisper_veil", "male_rage_pressure"],
        },
        "state_layers": [
        ...
        "boundary": {
            ...
            "state_fields_first_pixels_last": True,
            "no_external_visual_assets": True,
            "no_literal_gore": True,
            "no_cartoon_devil": True,
            "no_monster": True,
        },
    },
    {
        "preset_id": "edge_nightmare_world",
        "name": "Edge Nightmare World",
        "renderer": "truevision_weird_occlusion_rs",
        "scene_mode": "edge_nightmare_world",
        "visual_mode": "edge_nightmare_world",
        "status": "ready",
        "purpose": "Full-motion Edge Of The World nightmare lane: cliff-rim state, shifting camera POV, human silhouettes, top-down abyss views, falling camera spiral, river of color below, lightning bloom, roiling edge fog, and a gold-white release.",
        "default_size": [1080, 1920],
        "default_fps": 60,
        "runtime_defaults": {
            "render_threads": 32,
        ...
        "audio_mapping": {
            "rms": ["camera_push_pressure", "abyss_river_flow", "fog_breathing"],
            "bass": ["cliff_rim_weight", "falling_camera_spiral", "river_below_pulse"],
            "highs": ["branching_lightning_bloom", "silhouette_rim_light", "ash_ember_sparks"],
            "beat": ["arc_learning_transform_switch", "rim_flash", "top_down_drop"],
            "vocal_presence": ["human_silhouette_presence", "hope_release_lift"],
        },
        "state_layers": [
            "nightmare_cliff_rim",
            "wide_angle_push_in",
            "side_parallax_crossing",
            "top_down_abyss_view",
            "falling_camera_spiral",
            "under_edge_river_of_color",
            "human_silhouette_motion",
            "roiling_edge_fog",
            "branching_lightning_bloom",
            "ash_ember_drift",
        ...
        "boundary": {
            ...
            "state_fields_first_pixels_last": True,
            "no_external_visual_assets": True,
            "full_motion_camera_pov": True,
            "arc_solver_operator_discipline": True,
        },
    },
    {
        "preset_id": "daughter_star_locket_sea",
        "name": "Daughter Star Locket Sea",
        "renderer": "truevision_weird_occlusion_rs",
        "scene_mode": "daughter_star_locket_sea",
        "visual_mode": "daughter_star_locket_sea",
        "status": "ready",
        "purpose": "Heartbroken father-to-daughter lane: daughter as soft star, father as cracked heart locket, chain as bond, black water as distance, reflection as memory, fog as unsaid words, and gold-white hope as the thing that remains.",
        "default_size": [1080, 1920],
        "default_fps": 30,
        "runtime_defaults": {
            "render_threads": 32,
        ...
        "audio_mapping": {
            "rms": ["star_breath", "heart_locket_glow", "memory_fog_lift"],
            "bass": ["water_swell", "locket_weight", "distance_pressure"],
            "highs": ["star_edge_shimmer", "chain_sparkle", "tear_ripple_edges"],
            "beat": ["heart_crack_pulse", "reflection_ripple", "hope_bridge_flash"],
            "vocal_presence": ["father_reach_pressure", "daughter_answer_light"],
        },
        "state_layers": [
            "midnight_water_reflection",
            "daughter_star_glow",
            "cracked_father_heart_locket",
            "perspective_depth_plane",
            "dimensional_heart_locket_shading",
            "unbroken_chain_arc",
            "controlled_roiling_fog_field",
            "tear_ripple_field",
            "distant_horizon_blue",
            "gold_white_hope_fill",
            "geometric_state_transform_switching",
            "plane_depth_pulse",
            "fade_shimmer_gate",
            "soft_distortion_haze",
        ],
        "boundary": {
            "synthetic_state_media": True,
            "evidence": False,
            ...
            "state_fields_first_pixels_last": True,
            "no_external_visual_assets": True,
            "no_literal_faces": True,
            "no_cartoon_stars": True,
            "no_hallmark_scene": True,
            "fog_is_effect_not_story": True,
            "arc_solver_operator_discipline": True,
        },
    },
    {
